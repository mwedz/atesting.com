<?php include "header.php"; ?>
  ...
  <!-- Start Nav Backed Header -->
   <?php
               $id=$_GET['id'];
	$result = $db->prepare("SELECT * FROM vacancies where id= :post_id");
      ...
      <div class="row">
        <div class="col-md-12">
          <ol class="breadcrumb">
            ...
            <li><a href="vacancies-update.php">Vacancies Update</a></li>
            <li class="active"><?php echo $row['vacancy_title']; ?></li>
          </ol>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-9">
            <header class="single-post-header clearfix">
              <h2 class="post-title"><?php echo $row['vacancy_title']; ?></h2>
            </header>
